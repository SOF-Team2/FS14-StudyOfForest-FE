...
import GoalEditModal from "../components/goal/GoalEditModal.jsx";
import {
...
function DashboardPage() {
  ...
  const handleToggleStudies = () => {
    ...
    const studyCards = studySection?.querySelectorAll(".dashboard_study_card");
  ...
  return (
    <section className="dashboard_page">
      <div className="inner">
        <div className="card_container">
          <div className="container_title">
            <span>
              <span className="bold green">{currentUser?.nickname ?? ""}</span>{" "}
              님의 <span className="bold">대시보드</span>
            </span>
          </div>
            ...
            <div className="dashboard_study_grid" id="dashboard-study-grid">
              ...
              {visibleStudies.map((study, index) => {
                ...
                const cardClassName = [
                  ...
                  hasImageBackground ? "dashboard_study_card--image" : "",
                  animationClassName,
                ]
                  .filter(Boolean)
                  .join(" ");
      ...
      {isGoalModalOpen && (
        <GoalEditModal
          initialHours={goalCard.targetHours}
          onClose={() => setIsGoalModalOpen(false)}
          onSaved={(updatedGoalCard) => setGoalCard(updatedGoalCard)}
        />
      )}
    </section>
  );
